...
<?php $__env->startSection('title', 'Gerar Ciência'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('gerar.ciencia')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sisedu\resources\views/gerar_ciencia_form.blade.php ENDPATH**/ ?>